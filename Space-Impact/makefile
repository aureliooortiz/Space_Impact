...
SRC = main.c player.c controle.c arma.c bala.c utili.c inimigos.c colisao.c powerup.c
HEADERS = player.h controle.h arma.h bala.h utili.h inimigos.h colisao.h powerup.h
